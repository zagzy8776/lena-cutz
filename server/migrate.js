...
async function migrate() {
  ...
  // The original migration created the schema but never inserted the actual
  // services used by the customer-facing site. Seed them once when the table
  // is empty so a fresh deployment is immediately usable.
  ...
  if (!existingServices.length) {
    await sql`
      ...
      VALUES
        ('Low Cut', 'A clean, timeless low cut finished with sharp edges.', 30, 2000, 'https://images.pexels.com/photos/7447151/pexels-photo-7447151.jpeg?auto=compress&cs=tinysrgb&w=800', 1, true),
        ('High Fade', 'A bold high fade with a clean blend and crisp finish.', 45, 3000, 'https://images.pexels.com/photos/12464841/pexels-photo-12464841.jpeg?auto=compress&cs=tinysrgb&w=800', 2, true),
        ('Buzz Cut', 'A neat, low-maintenance buzz cut with an even finish.', 25, 1800, 'https://images.pexels.com/photos/4625632/pexels-photo-4625632.jpeg?auto=compress&cs=tinysrgb&w=800', 3, true),
        ('Taper Fade', 'A smooth taper fade blended around the sides and neckline.', 45, 3000, 'https://images.pexels.com/photos/12464840/pexels-photo-12464840.jpeg?auto=compress&cs=tinysrgb&w=800', 4, true),
        ('3 Step', 'A detailed three-step cut for a sharper, more defined look.', 50, 3500, 'https://images.pexels.com/photos/9971240/pexels-photo-9971240.jpeg?auto=compress&cs=tinysrgb&w=800', 5, true)
    `;
