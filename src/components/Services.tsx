      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-ink-400">
            Every service is delivered with precision and care. Choose your style and book in seconds.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <p className="py-20 text-center text-ink-400">{error}</p>
        ) : (
          <div className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {services.map((service, index) => (
              <div
                key={service.id}
                className="group relative overflow-hidden rounded-2xl border border-ink-700 bg-ink-900 transition-all duration-500 hover:border-gold-500/40 hover:shadow-xl hover:shadow-gold-500/5 animate-fade-in-up opacity-0"
              ...
              >
                ...
                <div className="relative h-56 overflow-hidden">
                  ...
                  {/* Price badge */}
                  <div className="absolute bottom-4 right-4 rounded-full bg-gold-500 px-4 py-1.5 text-sm font-bold text-ink-950 shadow-lg">
                ...
                <div className="p-6">
                  ...
                  <a
                    href="#booking"
                    className="mt-5 flex w-full items-center justify-center rounded-full border border-ink-600 py-2.5 text-sm font-semibold text-ink-100 transition-all duration-300 group-hover:border-gold-500 group-hover:bg-gold-500 group-hover:text-ink-950"
                  >
                    Book This Cut
                  </a>
                </div>
